                                      ...
                                      FormButton(
                                        onPressed: () async {
                                          if (_formKey.currentState!
                                            ...
                                            // String firstIndex = emailList[0];
                                            // String secondIndex = emailList[1];
                                            // debugdebugPrint(firstIndex.toUpperCase() +
                                            //     "@" +
                                            //     secondIndex);
                                            authBloc.add(SignInEventClick(
                                                // "202210084069FA",
                                                // "9087654321"
                                                // firstIndex.toUpperCase()+"@"+secondIndex,
                                                ///danielCredential
                                                //   "dc.daniel@stu.unizik.edu.ng",
                                                //   "8030000013"
                                                ///lizyCredential
